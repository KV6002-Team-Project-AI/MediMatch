...
def remove_duplicate_names(df):
    ...
    return df.drop_duplicates(subset=['Volunteer_Name'], keep=False)

def generate_Volunteer_id():
    generate_Volunteer_id.counter += 1
    return generate_Volunteer_id.counter

generate_Volunteer_id.counter = 0 
# Generate the dataset
volunteers = pd.DataFrame([{
    "Volunteer_ID": generate_Volunteer_id(),
    "Volunteer_Name": random_name(),
    "Age": random_age(),
