...
from Syed.views import StudyCreate, MatchedRecruitees, RecruiterMatchUpdate
...
urlpatterns = [
    ...
    path('api/recruitermatchupdate/<int:match_id>/', RecruiterMatchUpdate.as_view(), name='recruiter_match_update'),
