...
const DuetAlert = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { class: {
            ...
            }, role: this.announcements ? "alert" : undefined }, index.h("div", { class: {
                "duet-alert": true,
                ...
                [this.variation]: true,
                "duet-theme-turva": this.theme === "turva",
            } }, index.h("div", { class: "duet-alert-container", ref: element => {
                this.alertContainer = element;
            }, tabindex: this.focusable ? "0" : undefined }, this.icon && (index.h("div", { class: "duet-alert-icon" }, index.h("duet-icon", { size: "auto", name: this.icon, color: "currentColor" }))), index.h("span", { id: this.descriptiveId }, index.h("slot", null))), this.dismissible && (index.h("div", { class: "duet-alert-dismiss" }, index.h("duet-button", { variation: "plain", accessibleLabel: this.accessibleLabel, accessibleDescribedBy: this.descriptiveId, color: closeColor, iconSize: "medium", icon: "navigation-close", iconOnly: true, margin: "none", theme: this.theme, onClick: this.handleDismiss, fixed: true }))))));
    }
