...
const DuetBanner = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { class: { "duet-m-0": this.margin === "none" } }, index.h("aside", { class: {
                ...
                [this.size]: true,
            }, style: bannerStyles }, index.h("div", { class: "visual" }, index.h("div", { class: "image-container" }, this.image && index.h(DuetPicture, Object.assign({}, pictureSource))), this.icon && (index.h("duet-icon", { theme: this.theme, class: "icon", name: this.icon, shape: "brand", size: "xx-large", color: this.iconColor, background: this.iconBackgroundColor, "background-rotation": "7", "background-opacity": "0.85", margin: "none" }))), index.h("div", { class: "content" }, this.hasHeadingSlot && (index.h("div", { class: "heading" }, index.h("duet-heading", { theme: this.theme, level: this.headingLevel, "visual-level": "h2", margin: "none", color: this.textColor }, index.h("div", null, index.h("slot", { name: "heading" }))))), this.hasDescriptionSlot && (index.h("div", { class: "description" }, index.h("duet-paragraph", { theme: this.theme, margin: "none", color: this.textColor }, index.h("div", null, index.h("slot", { name: "description" }))))), this.hasActionSlot && (index.h("div", { class: "action" }, index.h("slot", { name: "action" })))))));
    }
