...
const DuetLink = class {
    ...
    initMediaQuery() {
        ...
        this.mediaQuery = window.matchMedia(tokenUtils.breakpointToToken["xx-small"]);
    ...
    renderContent() {
        return (index.h(index.Fragment, null, index.h("span", { class: "duet-link-content", part: "duet-link-content" }, index.h("slot", null)), this.external && (index.h(index.Fragment, null, index.h("span", { class: "duet-link-external" }, "\u00A0", index.h("duet-icon", { icon: actionNewWindowSmall.actionNewWindowSmall.svg, size: "xx-small", margin: "none", color: "currentColor" }))))));
    }
    renderGrid() {
