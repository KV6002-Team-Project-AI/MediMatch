...
const DuetCard = class {
    constructor(hostRef) {
        ...
        this.cardId = createId.createID("DuetCard");
        /**
         * Local methods.
         */
        this.togglePanel = (e) => {
    ...
    renderHeading() {
        ...
        const headingStyles = {
            backgroundColor: tokenUtils.getColorByName(this.headingBackground),
        };
        const headingContent = (index.h(index.Fragment, null, index.h("div", { class: "duet-card-heading-grid" }, this.icon && (index.h(index.Fragment, null, index.h("duet-icon", { class: "duet-card-icon", name: this.icon, size: "medium", margin: "none", color: "currentColor" }), index.h("duet-spacer", { direction: "horizontal", size: "small" }))), index.h("div", { class: "duet-card-heading-text" }, this.heading ? this.heading : index.h("slot", { name: "heading" })), this.secondaryHeading && (index.h(index.Fragment, null, index.h("duet-spacer", { direction: "horizontal", size: "small" }), index.h("div", { class: "duet-card-secondary-heading duet-card-secondary-heading--inline" }, this.secondaryHeading))), this.collapsible && (index.h(index.Fragment, null, index.h("duet-spacer", { direction: "horizontal", size: "small" }), index.h("duet-icon", { class: "duet-card-caret", icon: actionArrowUp.svg, size: "small", margin: "none", color: "currentColor" })))), this.secondaryHeading && (index.h("div", { class: "duet-card-secondary-heading duet-card-secondary-heading--new-line" }, this.secondaryHeading)), index.h("slot", { name: "below-heading" })));
        if (this.collapsible) {
            return (index.h(HeadingTag, { style: headingStyles, class: "duet-card-heading duet-card-heading--collapsible", onClick: this.togglePanel, onKeyDown: this.handleKeyDown }, index.h("button", { "aria-controls": this.cardId, "aria-expanded": this.open ? "true" : "false" }, headingContent)));
        }
        else {
            return (index.h(HeadingTag, { style: headingStyles, class: "duet-card-heading" }, headingContent));
        }
    }
    /**
    ...
    render() {
        ...
        return (index.h(index.Host, { class: {
            ...
            } }, this.image && (index.h("div", { class: "duet-card-image-mask" }, index.h("img", { src: this.image, class: "duet-card-image", loading: "lazy", alt: "", "aria-hidden": "true" }))), (this.heading || this.hasHeadingSlot) && this.renderHeading(), index.h("div", { class: "duet-card-content", id: this.cardId }, index.h("slot", null), this.hasFooter && (index.h("div", { class: "duet-card-footer" }, index.h("slot", { name: "footer" })))))));
    }
