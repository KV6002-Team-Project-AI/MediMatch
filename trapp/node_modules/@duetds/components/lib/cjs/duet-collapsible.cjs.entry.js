...
const DuetCollapsible = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { class: { "duet-m-0": this.margin === "none" } }, index.h(HeadingTagName, null, index.h("button", { class: {
