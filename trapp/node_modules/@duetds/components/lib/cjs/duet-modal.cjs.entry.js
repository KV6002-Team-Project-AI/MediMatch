...
const DuetModal = class {
    ...
    connectedCallback() {
        languageUtils.connectLanguageChangeObserver(this, { prop: "accessibleCloseLabel", defaults: "accessibleCloseLabelDefaults" });
    }
    ...
    render() {
        ...
        const closingButton = (index.h("div", { class: "duet-modal-close" }, index.h("duet-button", { ref: button => (this.buttonEl = button), variation: "plain", accessibleLabel: this.accessibleCloseLabel, color: closeColor, iconSize: "large", icon: "navigation-close", iconOnly: true, margin: "none", theme: this.theme, onClick: ev => this.closeModal(ev), fixed: true })));
        if (this.theme === "turva") {
        ...
        return (index.h("div", { ref: modal => (this.modalEl = modal), "aria-label": this.accessibleLabel, "aria-labelledby": this.heading ? this.modalId : false, "aria-details": this.accessibleDetails, "aria-description": this.accessibleDescription, "aria-describedby": this.accessibleDescribedBy, role: "dialog", "aria-modal": this.isSafariBrowser ? false : true, tabindex: "-1", "aria-flowto": this.slotDefaultId, class: {
            ...
            } }, index.h(focusUtils.FocusGuard, { moveFocusTo: this.buttonEl }), index.h("div", { ref: modalInner => (this.modalInnerEl = modalInner), class: {
                ...
                [this.size]: true,
                [this.variation]: true,
            } }, this.gutterSize !== "none" && !this.hasStickyHeader && index.h("duet-spacer", null), this.hasStickyHeader ? (index.h("div", { class: "duet-modal-sticky-header" }, closingButton, index.h("slot", { name: "sticky-header" }))) : (closingButton), index.h("div", { class: {
            ...
            } }, index.h("div", { class: "duet-modal-header" }, index.h("span", { class: "duet-modal-inner-slot-top" }, index.h("slot", { name: "top" })), this.icon && index.h("duet-icon", { name: this.icon, size: "xx-large", color: this.color || iconColor }), this.heading && (index.h("duet-heading", { "visual-level": (_a = this.headingVisualLevel) !== null && _a !== void 0 ? _a : this.headingLevel, level: this.headingLevel, theme: this.theme, id: this.modalId }, this.heading))), index.h("span", { class: "duet-modal-inner-slot-default", id: this.slotDefaultId }, index.h("slot", null))))), index.h(focusUtils.FocusGuard, { moveFocusTo: this.buttonEl })));
    }
