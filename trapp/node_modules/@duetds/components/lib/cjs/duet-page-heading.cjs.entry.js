...
const DuetPageHeading = class {
    ...
    render() {
        return (index.h("div", { class: {
                ...
                [this.layout]: true,
            } }, index.h("div", { class: "background" }, this.theme === "turva" && index.h("div", { class: "background-mask" }), this.theme !== "turva" && index.h("div", { class: "brand-shape" }), this.theme !== "turva" && index.h("div", { class: "brand-shape second-shape" }), this.icon && (index.h("div", { class: "brand-shaped-icon" }, index.h("duet-icon", { background: "none", name: this.icon, margin: "none", size: "auto", responsive: false })))), index.h("div", { class: "heading" }, index.h("slot", { name: "heading" }))));
    }
