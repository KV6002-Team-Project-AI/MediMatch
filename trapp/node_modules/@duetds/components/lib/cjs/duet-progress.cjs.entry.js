...
const DuetProgress = class {
    ...
    connectedCallback() {
        languageUtils.connectLanguageChangeObserver(this, { prop: "accessibleLabelUpload", defaults: "accessibleLabelUploadDefaults" });
    }
