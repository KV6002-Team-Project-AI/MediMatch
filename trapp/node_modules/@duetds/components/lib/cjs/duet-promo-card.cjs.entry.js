...
const DuetPromoCard = class {
     ...
     */
    render() {
        const backgroundColor = tokenUtils.getColorByName(this.backgroundColor, this.theme);
        const bannerStyles = {
        ...
        return (index.h(index.Host, { class: { "duet-m-0": this.margin === "none" } }, index.h("aside", { class: {
            ...
            }, style: bannerStyles }, index.h(TagName, { href: this.url, class: "content-wrapper" }, index.h("img", { class: "image", src: this.image, alt: "", role: "presentation" }), index.h("div", { class: "content" }, this.hasPreHeadingSlot && (index.h("div", { class: "pre-heading" }, index.h("slot", { name: "pre-heading" }))), this.hasHeadingSlot && (index.h("div", { class: "heading" }, index.h("duet-heading", { theme: this.theme, level: this.headingLevel, "visual-level": "h3", margin: "none", color: this.textColor }, index.h("div", null, index.h("slot", { name: "heading" }))))), this.hasDescriptionSlot && (index.h("div", { class: "description" }, index.h("duet-paragraph", { theme: this.theme, margin: "none", color: this.textColor }, index.h("div", null, index.h("slot", { name: "description" }))))), this.hasActionSlot && (index.h("div", { class: "action" }, index.h("slot", { name: "action" }))))))));
    }
    get element() { return index.getElement(this); }
};
DuetPromoCard.style = duetPromoCardCss;

exports.duet_promo_card = DuetPromoCard;
