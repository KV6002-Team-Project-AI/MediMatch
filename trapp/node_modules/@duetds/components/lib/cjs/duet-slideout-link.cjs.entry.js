...
const DuetSlideoutLink = class {
    ...
    render() {
        return (index.h(index.Host, null, index.h("a", { class: {
                ...
                active: this.active,
                [this.size]: true,
            }, href: this.href, "aria-current": this.active ? "true" : "false", lang: this.targetLanguage, hreflang: this.targetLanguage, "aria-label": this.accessibleLabel }, this.icon && (index.h("duet-icon", { name: this.icon, color: "secondary", size: this.menuItem ? "x-small" : "medium", margin: "none" })), index.h("div", { class: "label" }, index.h("span", null, index.h("slot", null), index.h("slot", { name: "description" })), this.caret && (index.h("duet-icon", { name: "action-arrow-right", color: "secondary", size: "x-small", margin: "none" }))))));
    }
