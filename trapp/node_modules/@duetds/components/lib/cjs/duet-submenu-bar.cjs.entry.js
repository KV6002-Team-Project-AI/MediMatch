...
const DuetSubmenuBar = class {
    constructor(hostRef) {
        ...
        this.enableBodyScroll = () => {
            if (this.nav) {
                bodyScrollLock_es6.enableBodyScroll(this.nav);
            }
            if (this.itemsContainer) {
                bodyScrollLock_es6.enableBodyScroll(this.itemsContainer);
            }
        };
        this.disableBodyScroll = () => {
            if (this.nav) {
                bodyScrollLock_es6.disableBodyScroll(this.nav, { reserveScrollBarGap: true });
            }
            if (this.itemsContainer) {
                bodyScrollLock_es6.disableBodyScroll(this.itemsContainer, { reserveScrollBarGap: true });
            }
        };
     ...
     */
    render() {
        return (index.h(index.Host, null, index.h("nav", { class: { "duet-submenu-bar": true, "duet-theme-turva": this.theme === "turva" }, "aria-label": this.accessibleLabel }, this.hasItems && (index.h("button", { ref: element => (this.button = element), "aria-haspopup": "menu", "aria-controls": "menu", "aria-expanded": this.open ? "true" : "false", id: "button", type: "button", class: {
                active: this.open,
                ...
                items: true,
                hidden: !this.open,
            }, ref: element => (this.itemsContainer = element) }, index.h("div", { class: "list", role: this.mobile ? "presentation" : "list" }, index.h("slot", null), index.h("div", { class: "list-padding" }))), index.h("div", { class: "mobile-background" })))));
    }
