...
const DuetToolbar = class {
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("nav", { class: { "duet-toolbar": true, "duet-theme-turva": this.theme === "turva", [variation]: true }, "aria-label": this.accessibleLabel }, index.h("div", { class: "container" }, index.h("div", { class: "list", role: "list" }, index.h("slot", { name: "left" })), index.h("div", { class: "list", role: "list" }, index.h("slot", { name: "right" }))))));
    }
    get element() { return index.getElement(this); }
};
DuetToolbar.style = duetToolbarCss;

exports.duet_toolbar = DuetToolbar;
