...
const DuetTooltipButton = class {
     ...
     */
    render() {
        return (index.h(index.Host, null, index.h("button", { ref: el => (this.buttonElement = el), "aria-controls": this.tooltipId, "aria-expanded": this.active ? "true" : "false", type: "button", class: {
...
const DuetTooltipPopup = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.tooltipPopupClosed = index.createEvent(this, "tooltipPopupClosed", 7);
    ...
    render() {
        return (index.h(index.Host, null, index.h("div", { class: {
            ...
            } }, index.h(focusUtils.FocusGuard, { moveFocusTo: this.buttonEl }), index.h("div", { ref: element => (this.contentEl = element), class: "duet-tooltip-content-area", tabindex: 0, id: this.tooltipId }, index.h("slot", null)), index.h("div", { ref: element => (this.arrowEl = element), class: { arrow: true, [this.placement]: true }, style: this.arrowStyles }, index.h("div", { class: { "arrow-container": true, [this.placement]: true } })), index.h("button", { type: "button", class: "duet-tooltip-close", onClick: this.handleCloseClick, ref: el => (this.buttonEl = el) }, index.h("duet-icon", { name: "navigation-close-small", margin: "none", color: "currentColor", size: "xxx-small" }), index.h("duet-visually-hidden", null, this.accessibleCloseLabel)), index.h(focusUtils.FocusGuard, { moveFocusTo: this.contentEl }))));
    }
    get element() { return index.getElement(this); }
...
exports.duet_tooltip_button = DuetTooltipButton;
exports.duet_tooltip_popup = DuetTooltipPopup;
