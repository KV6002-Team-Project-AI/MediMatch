...
import { DuetStringsExternalDefaults, DuetStringsLoadingDefaults } from "../../common-strings";
...
export class DuetButton {
    ...
    render() {
        ...
        const commonChildren = (h("span", { class: { "duet-button-contents": true, "icon-right": iconRight }, style: { color: getColorByName(this.color) } }, icon && (h("div", { "aria-hidden": "true", class: {
                "duet-button-icon": true,
                left: !iconRight,
                right: iconRight,
                [this.getButtonIconSize()]: true,
            } }, h("duet-icon", { size: "auto", margin: "none", name: icon, color: "currentColor" }))), h("span", { class: "duet-button-contents-slot" }, h("slot", null))));
        const commonProps = {
    ...
    static get properties() {
        return {
            ...
            "padding": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Controls the padding of the plain variation button - has no effect for other variations."
                },
                "attribute": "padding",
                "reflect": false,
                "defaultValue": "\"auto\""
            ...
            "accessibleLabelLoadingDefaults": {
                "type": "string",
                "mutable": false,
                "complexType": {
                    "original": "DuetLangObject | string",
                ...
                "docs": {
                    "tags": [{
                            "name": "default",
                            "text": "{fi: \"Ladataan\",sv: \"Lastning\",en: \"Loading\u2026\"}"
                        }],
                    "text": "Property to change accessibleLabelLoading defaults on the component.\nnormally you would handle these strings on an application level and override accessibleLabelLoading when needed"
                },
                "attribute": "accessible-label-loading-default",
                "reflect": false,
                "defaultValue": "DuetStringsLoadingDefaults"
            },
            "accessibleLabelLoading": {
                "type": "string",
                "mutable": true,
                "complexType": {
                    "original": "string",
                ...
                "docs": {
                    ...
                    "text": "Adds accessible label for button in \"loading\" state"
                },
                "attribute": "accessible-label-loading",
                "reflect": false,
                "defaultValue": "getLocaleString(this.accessibleLabelLoadingDefaults)"
            },
            "icon": {
                "type": "string",
                "mutable": false,
