...
:host(.duet-grid-variation-flex).duet-grid-align-stretch.duet-no-stacking {
...
:host(.duet-grid-variation-grid).duet-grid-template-sidebar-right::slotted(:nth-child(1)) {
  grid-column: 1/span 4;
}
@media (min-width: 48em) {
  :host(.duet-grid-variation-grid).duet-grid-template-sidebar-right::slotted(:nth-child(1)) {
...
:host(.duet-grid-variation-grid).duet-grid-template-sidebar-right::slotted(:nth-child(2)) {
  grid-column: 1/span 4;
}
@media (min-width: 48em) {
  :host(.duet-grid-variation-grid).duet-grid-template-sidebar-right::slotted(:nth-child(2)) {
...
:host(.duet-grid-variation-grid).duet-grid-template-sidebar-left::slotted(:nth-child(1)) {
  grid-column: 1/span 4;
}
@media (min-width: 48em) {
  :host(.duet-grid-variation-grid).duet-grid-template-sidebar-left::slotted(:nth-child(1)) {
...
:host(.duet-grid-variation-grid).duet-grid-template-sidebar-left::slotted(:nth-child(2)) {
  grid-column: 1/span 4;
}
@media (min-width: 48em) {
  :host(.duet-grid-variation-grid).duet-grid-template-sidebar-left::slotted(:nth-child(2)) {
...
:host(.duet-grid-variation-grid).duet-grid-template-two-columns::slotted(:nth-child(1)) {
  grid-column: 1/span 4;
}
@media (min-width: 48em) {
  :host(.duet-grid-variation-grid).duet-grid-template-two-columns::slotted(:nth-child(1)) {
...
:host(.duet-grid-variation-grid).duet-grid-template-two-columns::slotted(:nth-child(2)) {
  grid-column: 1/span 4;
}
@media (min-width: 48em) {
  :host(.duet-grid-variation-grid).duet-grid-template-two-columns::slotted(:nth-child(2)) {
...
:host(.duet-grid-variation-grid).duet-grid-template-three-columns::slotted(:nth-child(1)) {
  grid-column: 1/span 4;
}
@media (min-width: 48em) {
  :host(.duet-grid-variation-grid).duet-grid-template-three-columns::slotted(:nth-child(1)) {
...
:host(.duet-grid-variation-grid).duet-grid-template-three-columns::slotted(:nth-child(2)) {
  grid-column: 1/span 4;
}
@media (min-width: 48em) {
  :host(.duet-grid-variation-grid).duet-grid-template-three-columns::slotted(:nth-child(2)) {
...
:host(.duet-grid-variation-grid).duet-grid-template-three-columns::slotted(:nth-child(3)) {
  grid-column: 1/span 4;
}
@media (min-width: 48em) {
  :host(.duet-grid-variation-grid).duet-grid-template-three-columns::slotted(:nth-child(3)) {
