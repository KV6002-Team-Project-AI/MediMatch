...
@media (min-width: 62em) {
  .duet-hero.duet-hero-product.duet-theme-turva .background .brand-shaped-image:not(.narrow) {
    top: -230px;
    right: -180px;
    left: auto;
    width: 675px;
...
@media (min-width: 62em) {
  .duet-hero.duet-hero-product.duet-theme-turva .background .brand-shaped-image .brand-shaped-image-bg:not(.narrow) {
    width: 800px;
    height: 470px;
  }
}
...
@media (min-width: 62em) {
  .duet-hero.duet-hero-product.duet-theme-turva .background .brand-shaped-icon.narrow {
    top: 192px;
    right: 35%;
  }
}
...
@media (min-width: 76.25em) {
  .duet-hero.duet-hero-product.duet-theme-turva .background .brand-shaped-icon:not(.narrow) {
    right: 340px;
  }
}
