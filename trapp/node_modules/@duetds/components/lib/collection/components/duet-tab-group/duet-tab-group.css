...
@media (min-width: 36em) {
  .duet-tab-button {
    ...
    width: auto;
    margin-left: -2px;
    border-right: 2px solid rgb(225, 227, 230);
    border-radius: 0;
  }
}
...
.duet-tab-variation-checked .duet-tab-button.selected {
  color: rgb(0, 119, 179);
  background: linear-gradient(180deg, rgb(243, 249, 252) 0%, rgb(255, 255, 255) 100%);
  border-color: rgb(0, 119, 179);
  border-bottom-color: #fff;
}
.duet-theme-turva.duet-tab-variation-checked .duet-tab-button.selected {
  color: rgb(23, 28, 58);
  background: linear-gradient(180deg, rgb(245, 245, 247) 0%, rgb(255, 255, 255) 100%);
  border-color: rgb(68, 68, 69);
  border-bottom-color: #fff;
}
