...
const DuetBanner$1 = /*@__PURE__*/ proxyCustomElement(class DuetBanner extends H {
    ...
    render() {
        ...
        return (h$1(Host, { class: { "duet-m-0": this.margin === "none" } }, h$1("aside", { class: {
                "duet-banner": true,
                "duet-theme-turva": this.theme === "turva",
                [this.size]: true,
            }, style: bannerStyles }, h$1("div", { class: "visual" }, h$1("div", { class: "image-container" }, this.image && h$1(DuetPicture, Object.assign({}, pictureSource))), this.icon && (h$1("duet-icon", { theme: this.theme, class: "icon", name: this.icon, shape: "brand", size: "xx-large", color: this.iconColor, background: this.iconBackgroundColor, "background-rotation": "7", "background-opacity": "0.85", margin: "none" }))), h$1("div", { class: "content" }, this.hasHeadingSlot && (h$1("div", { class: "heading" }, h$1("duet-heading", { theme: this.theme, level: this.headingLevel, "visual-level": "h2", margin: "none", color: this.textColor }, h$1("div", null, h$1("slot", { name: "heading" }))))), this.hasDescriptionSlot && (h$1("div", { class: "description" }, h$1("duet-paragraph", { theme: this.theme, margin: "none", color: this.textColor }, h$1("div", null, h$1("slot", { name: "description" }))))), this.hasActionSlot && (h$1("div", { class: "action" }, h$1("slot", { name: "action" })))))));
    }
