...
const DuetCard$1 = /*@__PURE__*/ proxyCustomElement(class DuetCard extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
