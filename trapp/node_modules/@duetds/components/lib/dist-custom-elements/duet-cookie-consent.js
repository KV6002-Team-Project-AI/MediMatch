...
const DuetCookieConsent$1 = /*@__PURE__*/ proxyCustomElement(class DuetCookieConsent extends H {
     ...
     */
    render() {
        return (h(Host, { tabindex: "0", class: { "duet-theme-turva": this.theme === "turva" } }, h("div", { class: { "duet-cookie-consent": true, "duet-theme-turva": this.theme === "turva" } }, h("div", { class: "duet-cookie-consent-content" }, h("div", { class: "expand" }, h("slot", null)), h("duet-spacer", { size: "large", direction: "horizontal" }), h("div", null, h("duet-button", { variation: "negative", size: "small", onClick: this.handleClick, margin: "none", "aria-label": this.accessibleLabel, theme: this.theme }, "OK"))))));
    }
