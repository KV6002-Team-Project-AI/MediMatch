...
function defineCustomElement$1() {
    ...
    const components = ["duet-menu-bar-button", "duet-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "duet-menu-bar-button":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DuetMenuBarButton$1);
            }
            break;
        case "duet-icon":
            if (!customElements.get(tagName)) {
...
const DuetMenuBarButton = DuetMenuBarButton$1;
const defineCustomElement = defineCustomElement$1;

export { DuetMenuBarButton, defineCustomElement };
