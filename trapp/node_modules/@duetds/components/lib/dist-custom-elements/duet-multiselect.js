...
import { d as defineCustomElement$9 } from './p-4c5751cd.js';
import { d as defineCustomElement$8 } from './p-0156b860.js';
...
const DuetMultiselect$1 = /*@__PURE__*/ proxyCustomElement(class DuetMultiselect extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement$1() {
    ...
    const components = ["duet-multiselect", "duet-caption", "duet-checkbox", "duet-icon", "duet-label", "duet-tooltip", "duet-tooltip-button", "duet-tooltip-popup", "duet-visually-hidden"];
