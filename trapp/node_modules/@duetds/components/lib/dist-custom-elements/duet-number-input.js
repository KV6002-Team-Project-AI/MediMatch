...
const DuetNumberInput$1 = /*@__PURE__*/ proxyCustomElement(class DuetNumberInput extends H {
    constructor() {
        super();
        this.__registerHost();
...
function defineCustomElement$1() {
    ...
    const components = ["duet-number-input", "duet-button", "duet-caption", "duet-icon", "duet-input", "duet-label", "duet-spinner", "duet-tooltip", "duet-tooltip-button", "duet-tooltip-popup", "duet-visually-hidden"];
