...
function defineCustomElement$1() {
    ...
    const components = ["duet-popup-menu-item", "duet-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "duet-popup-menu-item":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DuetPopupMenuItem$1);
            }
            break;
        case "duet-icon":
            if (!customElements.get(tagName)) {
...
export { DuetPopupMenuItem, defineCustomElement };
