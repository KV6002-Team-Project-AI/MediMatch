...
import { d as defineCustomElement$3 } from './p-975a4689.js';
...
function defineCustomElement$1() {
    ...
    const components = ["duet-promo-card", "duet-heading", "duet-paragraph"];
    components.forEach(tagName => { switch (tagName) {
        case "duet-promo-card":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DuetPromoCard$1);
            }
            break;
        case "duet-heading":
            if (!customElements.get(tagName)) {
...
const DuetPromoCard = DuetPromoCard$1;
const defineCustomElement = defineCustomElement$1;

export { DuetPromoCard, defineCustomElement };
