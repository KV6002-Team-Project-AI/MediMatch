...
function defineCustomElement$1() {
    ...
    const components = ["duet-section-layout"];
    components.forEach(tagName => { switch (tagName) {
        case "duet-section-layout":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DuetSectionLayout$1);
            }
            break;
    } });
}

const DuetSectionLayout = DuetSectionLayout$1;
const defineCustomElement = defineCustomElement$1;

export { DuetSectionLayout, defineCustomElement };
