...
function defineCustomElement$1() {
    ...
    const components = ["duet-slideout-lang", "duet-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "duet-slideout-lang":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DuetSlideoutLang$1);
            }
            break;
        case "duet-icon":
            if (!customElements.get(tagName)) {
...
const DuetSlideoutLang = DuetSlideoutLang$1;
const defineCustomElement = defineCustomElement$1;

export { DuetSlideoutLang, defineCustomElement };
