...
function defineCustomElement$1() {
    ...
    const components = ["duet-slideout-link", "duet-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "duet-slideout-link":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DuetSlideoutLink$1);
            }
            break;
        case "duet-icon":
            if (!customElements.get(tagName)) {
...
const DuetSlideoutLink = DuetSlideoutLink$1;
const defineCustomElement = defineCustomElement$1;

export { DuetSlideoutLink, defineCustomElement };
