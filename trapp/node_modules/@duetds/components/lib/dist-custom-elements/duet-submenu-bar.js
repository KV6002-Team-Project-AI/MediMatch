...
import { e as enableBodyScroll, d as disableBodyScroll } from './p-141e14d0.js';
...
function defineCustomElement$1() {
    ...
    const components = ["duet-submenu-bar", "duet-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "duet-submenu-bar":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DuetSubmenuBar$1);
            }
            break;
        case "duet-icon":
            if (!customElements.get(tagName)) {
...
const DuetSubmenuBar = DuetSubmenuBar$1;
const defineCustomElement = defineCustomElement$1;

export { DuetSubmenuBar, defineCustomElement };
