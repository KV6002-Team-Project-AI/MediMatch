...
const DuetToolbarLink$1 = /*@__PURE__*/ proxyCustomElement(class DuetToolbarLink extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement$1() {
    ...
    const components = ["duet-toolbar-link", "duet-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "duet-toolbar-link":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DuetToolbarLink$1);
            }
            break;
        case "duet-icon":
            if (!customElements.get(tagName)) {
...
const DuetToolbarLink = DuetToolbarLink$1;
const defineCustomElement = defineCustomElement$1;

export { DuetToolbarLink, defineCustomElement };
