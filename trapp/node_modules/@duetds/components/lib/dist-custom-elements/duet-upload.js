 ...
 */
import { p as proxyCustomElement, H, c as createEvent, h as h$1, F as Fragment, d as Host } from './p-471a62cc.js';
...
import { g as getError, d as defineCustomElement$3, a as getI18nError } from './p-d517fc9a.js';
import { h } from './p-62c7d9d4.js';
import { d as defineCustomElement$i } from './p-4d3e1b52.js';
import { d as defineCustomElement$h } from './p-4a55dff3.js';
import { d as defineCustomElement$g } from './p-1c7bd169.js';
import { d as defineCustomElement$f } from './p-6b977095.js';
import { d as defineCustomElement$e } from './p-4c5751cd.js';
import { d as defineCustomElement$d } from './p-583e21a8.js';
import { d as defineCustomElement$c } from './p-8735b4db.js';
import { d as defineCustomElement$b } from './p-975a4689.js';
import { d as defineCustomElement$a } from './p-c493eecb.js';
import { d as defineCustomElement$9 } from './p-9a9a04bd.js';
import { d as defineCustomElement$8 } from './p-fc6bb9ab.js';
import { d as defineCustomElement$7 } from './p-254a95d4.js';
import { d as defineCustomElement$6 } from './p-3158e24f.js';
import { d as defineCustomElement$5 } from './p-9b174e03.js';
import { d as defineCustomElement$4 } from './p-9c2d3a9d.js';
...
const DuetUpload$1 = /*@__PURE__*/ proxyCustomElement(class DuetUpload extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
        ...
        this.mapFilesToUploadItems = (data, group, showCategory, filteredActions) => {
            if (group === this.DefaultGroups.success) {
                return (h$1("duet-upload-item", { theme: this.theme, actions: this.getActions(group, filteredActions), type: "success", data: data, showLinks: this.showLinks, linkClickEvent: this.emitEvent ? this.linkClick : undefined, categoryLabel: this.categoryLabel, label: this.uploadedItemsHeaderLabel, showCategory: showCategory, ref: item => {
                        this.itemRefs.set(data.uid, item);
                    } }));
            }
            else if (group === this.DefaultGroups.inprogress) {
                return (h$1("duet-upload-item", { theme: this.theme, actions: this.getActions(group, filteredActions), type: "inprogress", data: data, showLinks: this.showLinks, categoryLabel: this.categoryLabel, label: this.uploadedItemsHeaderLabel, showCategory: showCategory, ref: item => {
                        this.itemRefs.set(data.uid, item);
                    } }));
            }
            else if (group === this.DefaultGroups.pending) {
                return (h$1("duet-upload-item", { theme: this.theme, actions: this.getActions(group, filteredActions), type: "pending", data: data, showLinks: this.showLinks, categoryLabel: this.categoryLabel, label: this.uploadedItemsHeaderLabel, showCategory: showCategory, ref: item => {
                        this.itemRefs.set(data.uid, item);
                    } }));
            }
            else if (group === this.DefaultGroups.failure) {
                return (h$1("duet-upload-item", { theme: this.theme, actions: this.getActions(group, filteredActions), type: "failure", data: data, showLinks: this.showLinks, errorCodes: this.errorCodes, categoryLabel: this.categoryLabel, label: this.uploadedItemsHeaderLabel, showCategory: showCategory, ref: item => {
                        this.itemRefs.set(data.uid, item);
                    } }));
            }
            else if (data.group) {
        ...
        this.renderUploadedItems = () => {
            ...
            const ItemRows = this.groups.map(group => {
                ...
                return (h$1(Fragment, null, !this.hideGroups && (h$1(UploadItemHeader, { categoryLabel: hasCategory ? this.categoryLabel : undefined, label: group.label })), currentItems.map(item => this.mapFilesToUploadItems(item.data, group.id, hasCategory, filteredActions))));
            });
...
function defineCustomElement$1() {
    ...
    const components = ["duet-upload", "duet-action-button", "duet-alert", "duet-badge", "duet-button", "duet-caption", "duet-empty-state", "duet-fieldset", "duet-heading", "duet-icon", "duet-link", "duet-paragraph", "duet-progress", "duet-spacer", "duet-spinner", "duet-upload-aria-status", "duet-upload-item", "duet-visually-hidden"];
