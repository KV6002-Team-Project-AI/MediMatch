...
const DuetProgress = /*@__PURE__*/ proxyCustomElement(class DuetProgress extends H {
    constructor() {
        super();
        this.__registerHost();
        /**
