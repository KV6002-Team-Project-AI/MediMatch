...
import { d as defineCustomElement$4 } from './p-6b977095.js';
import { d as defineCustomElement$3 } from './p-c493eecb.js';
import { d as defineCustomElement$2 } from './p-9b174e03.js';
...
const DuetAlert = /*@__PURE__*/ proxyCustomElement(class DuetAlert extends H {
    ...
    render() {
        ...
        return (h(Host, { class: {
            ...
            }, role: this.announcements ? "alert" : undefined }, h("div", { class: {
                "duet-alert": true,
                ...
                [this.variation]: true,
                "duet-theme-turva": this.theme === "turva",
            } }, h("div", { class: "duet-alert-container", ref: element => {
