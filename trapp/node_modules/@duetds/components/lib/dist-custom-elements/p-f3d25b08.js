...
import { j as colorGrayLightest, k as colorBrandGrayTurva, l as colorPrimaryTurva, n as colorPrimary } from './p-2b56c0d7.js';
...
const DuetLogo = /*@__PURE__*/ proxyCustomElement(class DuetLogo extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
