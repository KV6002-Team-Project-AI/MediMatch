 ...
 */
import { h, r as registerInstance, H as Host, g as getElement } from './index-909a963e.js';
...
const DuetPicture = ({ img, sources }) => {
    return (h("picture", null,
        sources &&
            sources.map(source => (h("source", { srcSet: source.srcset, media: source.media, type: source.type, sizes: source.sizes }))),
...
const DuetBanner = class {
    ...
    render() {
        ...
        return (h(Host, { class: { "duet-m-0": this.margin === "none" } }, h("aside", { class: {
                ...
                [this.size]: true,
            }, style: bannerStyles }, h("div", { class: "visual" }, h("div", { class: "image-container" }, this.image && h(DuetPicture, Object.assign({}, pictureSource))), this.icon && (h("duet-icon", { theme: this.theme, class: "icon", name: this.icon, shape: "brand", size: "xx-large", color: this.iconColor, background: this.iconBackgroundColor, "background-rotation": "7", "background-opacity": "0.85", margin: "none" }))), h("div", { class: "content" }, this.hasHeadingSlot && (h("div", { class: "heading" }, h("duet-heading", { theme: this.theme, level: this.headingLevel, "visual-level": "h2", margin: "none", color: this.textColor }, h("div", null, h("slot", { name: "heading" }))))), this.hasDescriptionSlot && (h("div", { class: "description" }, h("duet-paragraph", { theme: this.theme, margin: "none", color: this.textColor }, h("div", null, h("slot", { name: "description" }))))), this.hasActionSlot && (h("div", { class: "action" }, h("slot", { name: "action" })))))));
    }
    get element() { return getElement(this); }
};
DuetBanner.style = duetBannerCss;

export { DuetBanner as duet_banner };
