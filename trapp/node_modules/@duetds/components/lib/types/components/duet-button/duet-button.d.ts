...
export type DuetButtonSize = "x-small" | "small" | "medium";
export declare class DuetButton implements ThemeableComponent, FormComponent, A11yComponent {
    ...
    margin: DuetMargin;
    /**
     * Controls the padding of the plain variation button - has no effect for other variations.
     */
    padding: DuetPadding;
    /**
    ...
    /**
     * Property to change accessibleLabelLoading defaults on the component.
     * normally you would handle these strings on an application level and override accessibleLabelLoading when needed
     * @default {fi: "Ladataan",sv: "Lastning",en: "Loading…"}
     */
    accessibleLabelLoadingDefaults: DuetLangObject | string;
    /**
     * Adds accessible label for button in "loading" state
     * @default {fi: "Ladataan",sv: "Lastning",en: "Loading…"}
     */
    accessibleLabelLoading: string;
    /**
