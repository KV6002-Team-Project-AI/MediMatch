...
export declare class DuetChoice implements ThemeableComponent, InputComponent, A11yComponent {
     ...
     */
    collapsibleNotificationDefaults: DuetLangObject | string;
    /**
     ...
     */
    duetChoiceReady: EventEmitter<CustomEvent>;
    /**
     * Emitted when the component is removed from the DOM.
     */
    duetChoiceRemove: EventEmitter<CustomEvent>;
    /**
     ...
     */
    private isCollapsibleAnnounceable;
