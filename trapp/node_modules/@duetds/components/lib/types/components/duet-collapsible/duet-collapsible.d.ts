...
export type DuetCollapsibleWeight = "semibold" | "normal";
export type DuetCollapsibleHeadingFontSize = "x-small" | "small" | "medium" | "large" | "x-large" | "xx-large" | "xxx-large" | "xxxx-large" | undefined;
export type DuetCollapsibleToggleEvent = {
...
export declare class DuetCollapsible implements ThemeableComponent {
    ...
    theme: DuetTheme;
    /**
     * Adds accessible label for the collapsible that is only shown for screen readers.
