...
import { DuetIconName, DuetLanguage, DuetMargin, DuetTextFontWeight, DuetTheme, DuetTooltipDirection } from "../../common-types";
export type DuetInputEvent = {
    originalEvent?: Event;
    value: string;
    component: "duet-input";
};
export type DuetInputType = "text" | "email" | "password" | "search" | "tel" | "time";
export type DuetInputComponentType = "input" | "number" | "date";
export type DuetVariationType = "default" | "button" | "revealable";
export declare class DuetInput implements ThemeableComponent, InputComponent, A11yComponent {
    ...
    private errorId;
    private nativeInput?;
    private togglePasswordRevealedButton?;
    private isCaptionVisible;
    private timeoutId;
    private disallowPatternRegex;
    private clearLabel;
    private timeAnnouncement;
    private showPasswordLabel;
    private hidePasswordLabel;
    private passwordShownAriaAnnouncement;
    private passwordHiddenAriaAnnouncement;
    /**
    ...
    /**
     * Indicates whether the password is revealed.
     */
     ...
     */
    labelWeight: DuetTextFontWeight;
    /**
