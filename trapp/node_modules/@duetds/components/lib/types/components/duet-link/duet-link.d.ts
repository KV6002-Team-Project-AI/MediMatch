import { DuetIconColor, DuetIconName, DuetLanguage, DuetLinkVariation, DuetPadding, DuetTheme } from "../../common-types";
...
export declare class DuetLink implements ThemeableComponent {
    ...
    tabToLink: boolean;
    /**
     * Icon to display on the left side of the ink text (only with "block" variation)
     */
    icon: DuetIconName;
    /**
     * Color of the icon to display (only with "block" variation)
     */
    iconColor: DuetIconColor;
    /**
     * Whether the icon changes its size responsively (only with "block" variation)
     */
    iconResponsive: boolean;
    /**
     * Controls the padding of the component (only with "block" variation)
     */
    padding: DuetPadding;
    /**
     * Stores the
