...
import { DuetLanguage, DuetMargin, DuetTextFontWeight, DuetTheme, DuetTooltipDirection } from "../../common-types";
import { ThemeableComponent } from "../../common/themeable-component";
export type DuetMultiselectItem = {
    label: string;
    value: string;
    disabled?: boolean;
};
export type DuetMultiselectEvent = {
    originalEvent?: Event;
