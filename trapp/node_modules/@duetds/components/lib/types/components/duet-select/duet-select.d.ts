...
import { DuetMargin, DuetTextFontWeight, DuetTheme, DuetTooltipDirection } from "../../common-types";
...
export type DuetSelectVariation = "default" | "compact" | "tiny";
...
export declare class DuetSelect implements ThemeableComponent, InputComponent {
    ...
    /**
     * Variation of dropdown. Tiny is used for small numbers / tiny option ranges. Compact works well with adjacent buttons,
