...
import { DuetHeadingLevel, DuetMargin, DuetTheme, StatusMessage } from "../../common-types";
...
export declare class DuetUpload implements ThemeableComponent, FormComponent {
     ...
     */
    headerHeadingLevel: DuetHeadingLevel;
    /**
    ...
    /**
     * Emitted when the user clicks the uploaded file link and link-click-event prop is set to true
     */
    linkClick: EventEmitter<DuetUploadEvent>;
    /**
     * Own Properties
     */
    private buttonId;
