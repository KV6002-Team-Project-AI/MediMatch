...
var createReactComponent = function (tagName, portal) {
    ...
    var ReactComponent = /** @class */ (function (_super) {
        ...
        class_1.prototype.render = function () {
            ...
            var newProps = __assign(__assign({}, propsToPass), { ref: (0, utils_1.mergeRefs)(forwardedRef, this.setComponentElRef), style: style, "data-react-portal": portal });
            /**
             ...
             */
            var element = (0, react_1.createElement)(tagName, newProps, children);
            var skipTeleport = cProps["skip-teleport"];
            if (portal && typeof window !== "undefined" && !skipTeleport) {
                return react_dom_1.default.createPortal(element, document.body);
            }
            else {
                return element;
            }
