                            ...
                            <div className='w-full'>
                                    ...
                                    <div className='flex-col w-full'>
                                        <div className="flex justify-between items-center">
                                            ...
                                            <img
                                                src={infoLogo}
                                                alt="info"
                                                className="w-4 h-4 hover:bg-gray-200 mb-4 rounded-xl transition duration-300 ease-in-out transform hover:-translate-y-0.5"
                                                onClick={() => toggleProfileExpansion(index)}
                                            />
                                        </div>
                                        <div>
                                            <p className="text-sm mr-0.5">
                                ...
                                {!expandedProfiles[index] && 
                                    <div className="flex gap-2 text-sm m-3">
                                        ...
                                        <div className="bg-amber-100 w-full text-black p-2 rounded-lg shadow transition duration-300 ease-in-out transform hover:-translate-y-1 hover:shadow-lg">
